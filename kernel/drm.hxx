...
void GenKey(uint32_t parray[32], uint32_t sbox[4][256], const void *key, size_t keylen)
{
    ...
    static const uint32_t bfSbox[4][256] = {
        {
    ...
    static const uint32_t bfParray[32] = {
    ...
    std::memcpy(parray, bfParray, sizeof(uint32_t) * 32);
    std::memcpy(sbox, bfSbox, sizeof(uint32_t) * 4 * 256);
